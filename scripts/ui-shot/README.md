...
| `splice-through` | switch on all three MOVE THROUGH layers of the added splice (kit, drum, around) with a dragged drum order, so every layer and both order controls render |
